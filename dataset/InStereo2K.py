...
class InStereo2K(Dataset):
    ...
    def __init__(self, path, set_type, resize=(128, 128)):
        super(Dataset, self).__init__()
        self.resize = resize

        self.ar = []
        idx_path = './dataset/data_paths/InStereo2K_' + set_type + '.txt'
    ...
    def train_deterministic_cropping(self, img, side_img):
        # Center Crop
        img = TF.center_crop(img, (370, 370))
        side_img = TF.center_crop(side_img, (370, 370))
